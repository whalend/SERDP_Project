...
Fine surface fuels play a major role in the ignition, spread, and intensity of fires. Fire intensity is determined by weather conditions and fuel charateristics, including load, moisture, continuity, and structure. 
...
Studies in fire ecology that experimentally manipulate fuel often only change the fuel load or type, necessarily sacrificing some realism in fuel structure. Fuels are typically laid horizontally even though fuel complexes are often more heterogeneous with subtantial vertical structure. 
