...
max_temp_fig <- ggplot(d1, aes(total_biomass, avg2_max_temp)) +
      ...
      scale_shape_manual(values = c("prescribed" = 23, "piled" = 2, "standing" = 0, "both" = 19)) +
      scale_color_manual(values = c("piled" = "red", "standing" = "deepskyblue", "prescribed" = "black", "both" = "purple")) +
      scale_fill_manual(values = c("both"="purple","piled"="red","standing"="cyan")) +
