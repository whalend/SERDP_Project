...
plot_visit_data$imcy_inv <- factor(plot_visit_data$imcy_inv, levels=c("uninvaded","invaded"))
...
ggplot(basal_area_data,
       aes(as.factor(years_since_fire), total_basal_area_ha)
      ) +
...
ggplot(dung_data_avg, 
       aes((years_since_fire), (avg_clusters1m), color = imcy_inv)) +
      geom_point(size = 2) +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .1) +
...
# plot_data
d1 <- left_join(plot_visit_data, tick_data_sum)
...
d1$imcy_inv <- factor(d1$imcy_inv, levels = c("uninvaded","invaded"))
...
ggplot(d1, aes(ycoord_lat, (total_ticks), color = imcy_inv)) +
      geom_point(position = "jitter") +
      invasion_color +
      invasion_fill + 
...
ggplot(d1, aes(years_since_fire, (total_ticks), color = imcy_inv)) +
      geom_point(position = "jitter") +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .2) +
...
ggplot(d1, aes(avg_veg_cover, (total_ticks), color = imcy_inv)) +
      geom_point(position = "jitter") +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .2) +
...
ggplot(d1, aes((avg_standing_gm2), (total_ticks), color = imcy_inv)) +
      geom_point() +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), method = "loess", se = T, alpha = .2) +
      theme_classic() +
...
ggplot(d1, aes(avg_pct_litter, (total_ticks), color = imcy_inv)) +
      geom_point(position = "jitter") +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .2) +
...
ggplot(d1, aes(avg_litter_gm2, (total_ticks), color = imcy_inv)) +
      geom_point(position = "jitter") +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .2) +
...
ggplot(d1, aes(avg_canopy_cover, (total_ticks), color = imcy_inv)) +
      geom_point() +
      invasion_color +
      invasion_fill +
      geom_smooth(aes(fill = imcy_inv), se = T, alpha = .2) +
...
cogon_biomass <- left_join(
      cogon_biomass,
      select(plot_visit_data, installation,plot_id,years_since_fire),
