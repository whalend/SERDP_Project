...
plot_visit_data <- left_join(plot_visit_data, plot_data)
...
species_data <- left_join(
      species_data,
      select(plot_visit_data, installation:years_since_fire, installation_full_name),
      by = c("installation","plot_id")
)
...
tick_data <- left_join(
      tick_data,
      select(plot_data, installation,plot_id,fire_year:installation_full_name),
      by = c("installation", "plot_id")
)
# summary(tick_data)
