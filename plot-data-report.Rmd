...
library(rgdal); library(sp); library(maptools); library(sf)
installations <- readOGR("data/selected_installations.shp")
...
tick_data <- tick_data_import %>% 
      mutate(life_stage = factor(life_stage, levels = c("A","N","L"),))
summary(tick_data)
