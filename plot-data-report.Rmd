...
(fxgroup_cover_fig <- ggplot(filter(fx_group_data, !is.na(last_fire_year)), 
       aes(years_since_fire, pct_cover)) +
      geom_point(aes(color = imcy_inv), position = position_jitter(width=.15), alpha = .5) +
...
```{r ggpairs plot, eval=T, fig.width=14, fig.height=14}
