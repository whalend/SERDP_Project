...
# ggsave("figures/interim_report_num_of_plots.png", num_of_plots, width =7.5, height = 7.5)
...
shrub_saplings_fig <- ggplot(
      ...
      def_theme +
      xlab("Years since fire") +
      ylab(expression(paste("Shrub & sapling density (", {m}^-2,") "))) +
      ggtitle("") +
      NULL
...
# ggsave("figures/interim_report_tree_richness.png", width =7.5, height = 7.5)
...
# ggsave("figures/interim_report_veg_cover.png", width =7.5, height = 7.5)
...
plot_grid(
      ...
      litter_moisture_fig +
            theme(legend.position = "none"),
      ncol = 1, labels = "auto", label_x = .1
)
# ggsave("figures/interim_report_litter.png", width =7.5, height = 7.5)
